# `r`n  part is what prints a carage return and new line for the cli output. 
...
$RDPevents = @()  
## For loops.  Loops all rdp events, assiging their IDs to human readable output.           
...
### IF the events domain property anything but null or 0, add the event to an object.      
